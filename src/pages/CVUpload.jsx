...
export default function CVUpload() {
  const { uploadCV, pollAnalysisResults, clearCV, getAnalysisData, loading, error, isPolling } = useCV()
...
const styles = {
  ...
  scoreCircle: {
    ...
    justifyContent: 'center',
    flexShrink: 0,
    boxShadow: '0 4px 14px rgba(79,163,224,0.35)',
  },
  
  scoreNumber: { fontSize: 24, fontWeight: 700, color: 'white', lineHeight: 1.1 },
  scoreMax: { fontSize: 11, color: 'rgba(255,255,255,0.75)', lineHeight: 1.1 },
  scoreTextWrap: { flex: 1, minWidth: 180 },
